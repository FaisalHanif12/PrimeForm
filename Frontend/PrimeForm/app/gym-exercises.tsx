...
const exerciseDatabase = {
  ...
  full_body: [
    ...
    },
    {
      ...
      calories: 50,
      equipment: 'None',
      primaryMuscles: ['Hip Flexors', 'Groin'],
      secondaryMuscles: ['Core', 'Flexibility'],
      description: 'Stretching and mobility exercise',
      tips: ['Sit with soles together', 'Press knees down', 'Lean forward gently'],
    },
    {
      id: 'running',
